...
mixin _$ItemResDm {
 ...
 String get id; String get name; String get serialNo; String get categoryId; String get ownerType; String? get clientName; String get status; String? get currentOwnerId; DateTime? get purchaseDate; String get qrCodeToken; DateTime? get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,serialNo,categoryId,ownerType,clientName,status,currentOwnerId,purchaseDate,qrCodeToken,createdAt,updatedAt);

@override
String toString() {
  return 'ItemResDm(id: $id, name: $name, serialNo: $serialNo, categoryId: $categoryId, ownerType: $ownerType, clientName: $clientName, status: $status, currentOwnerId: $currentOwnerId, purchaseDate: $purchaseDate, qrCodeToken: $qrCodeToken, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String serialNo, String categoryId, String ownerType, String? clientName, String status, String? currentOwnerId, DateTime? purchaseDate, String qrCodeToken, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of ItemResDm
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? serialNo = null,Object? categoryId = null,Object? ownerType = null,Object? clientName = freezed,Object? status = null,Object? currentOwnerId = freezed,Object? purchaseDate = freezed,Object? qrCodeToken = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
switch (_that) {
case _ItemResDm() when $default != null:
return $default(_that.id,_that.name,_that.serialNo,_that.categoryId,_that.ownerType,_that.clientName,_that.status,_that.currentOwnerId,_that.purchaseDate,_that.qrCodeToken,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String serialNo,  String categoryId,  String ownerType,  String? clientName,  String status,  String? currentOwnerId,  DateTime? purchaseDate,  String qrCodeToken,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ItemResDm():
return $default(_that.id,_that.name,_that.serialNo,_that.categoryId,_that.ownerType,_that.clientName,_that.status,_that.currentOwnerId,_that.purchaseDate,_that.qrCodeToken,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
class _ItemResDm implements ItemResDm {
  const _ItemResDm({this.id = '', this.name = '', this.serialNo = '', this.categoryId = '', this.ownerType = 'company', this.clientName, this.status = 'available', this.currentOwnerId, this.purchaseDate, this.qrCodeToken = '', this.createdAt, this.updatedAt});
...
/// Create a copy of ItemResDm
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? serialNo = null,Object? categoryId = null,Object? ownerType = null,Object? clientName = freezed,Object? status = null,Object? currentOwnerId = freezed,Object? purchaseDate = freezed,Object? qrCodeToken = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
