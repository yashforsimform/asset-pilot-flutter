              ...
              Flexible(
                child: BlocConsumer<ChatbotCubit, ChatbotState>(
                  listener: (context, state) {
                    // Auto-scroll after each new message / loading change.
    ...
    return Align(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
          maxWidth: MediaQuery.sizeOf(context).width * 0.6 > 300
              ? 300
...
class _TypingDot extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Offsets progress by [delay] so each dot bounces in sequence, then maps
    // it through a triangle wave for a smooth up-down bob.
